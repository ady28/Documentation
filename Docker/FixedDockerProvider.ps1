...
function Get-HttpResponse
{
    ...
    $response = Invoke-WebRequest -Uri $Uri -Proxy http://192.168.1.254:80 -UseBasicParsing -Method HEAD
...
function DownloadFile
{
    ...
    try
    {
        ...
        if($downloadURL.StartsWith("https://"))
        {
            ...
            Invoke-WebRequest -Uri $downloadURL -Proxy http://192.168.1.254:80 -OutFile $destination
