...
$snaps=Get-VMSnapshot -VMName 'TestVM' -SnapshotType Replica
Start-VMFailover -VMRecoverySnapshot $snaps[1] -Confirm:$false
Complete-VMFailover -VMName 'TestVM' -Confirm:$false
Set-VMReplication -VMName TestVM -AsReplica #Run on new replica host
Set-VMReplication -Reverse -VMName 'TestVM'
Start-VMInitialReplication -VMName 'TestVM'
