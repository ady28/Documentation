...
Get-VirtualDisk –FriendlyName VirtualDisk1 | Get-Disk | Initialize-Disk -PartitionStyle GPT –Passthru | New-Partition –AssignDriveLetter –UseMaximumSize | Format-Volume -FileSystem ReFS -Confirm:$false