...
New-VirtualDisk -StoragePoolFriendlyName 'StoragePool3' -FriendlyName 'VirtualDisk1' -ResiliencySettingName 'Mirror' -ProvisioningType Fixed -NumberOfDataCopies 3 -StorageTiers $Fast,$Slow -StorageTierSizes 2GB,4GB
#Create a volume
